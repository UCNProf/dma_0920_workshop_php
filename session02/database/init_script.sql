...
INSERT INTO `notes` (`id` ,`date`, `user_id`, `title`, `content`) VALUES
  (1, '2022-01-26 17:27:49', 1, 'Note 1', 'Content for note 1'),
  (2, '2022-02-08 11:17:16', 1, 'Note 2', 'Content for note 2');